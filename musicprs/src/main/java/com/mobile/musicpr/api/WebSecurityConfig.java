...
import it.mobile.whistle.common.spring.security.JWTAuthenticationEntryPoint;
import it.mobile.whistle.common.spring.security.JWTAuthenticationTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable().exceptionHandling().authenticationEntryPoint(unauthorizedHandler).and()
				...
				.antMatchers("/","/upload.htm", "/*.html", "/favicon.ico", "/**/*.html", "/**/*.css", "/**/*.js", "/api/login/**").permitAll()
